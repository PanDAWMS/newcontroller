...
#                print 'multicloud: ', multicloud
                if dest != '':
                    self.InsertAndUpdate(dest, multicloud, i['MULTICLOUD_DESTINATION'])
